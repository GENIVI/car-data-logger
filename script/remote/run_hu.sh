...
$script_path/script/start_hu_av_information_provider.sh &

sleep 1

$script_path/script/start_headunit_vehicle_data_consumer-climates.sh &

sleep 1

$script_path/script/start_headunit_vehicle_data_consumer-running-status.sh &
