...
export VSOMEIP_APPLICATION_NAME=headunit-vehicle-data-consumer-climates
export VSOMEIP_CONFIGURATION=$script_path/../../json/remote/vsomeip-head-unit.json
export LD_LIBRARY_PATH=$script_path/../../lib:$LD_LIBRARY_PATH

$script_path/../../bin/headunit-vehicle-data-consumer-climates
