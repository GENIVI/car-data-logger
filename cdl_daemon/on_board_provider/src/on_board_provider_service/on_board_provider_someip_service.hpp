...
#ifndef ONBOARDPROVIDERSOMEIPSERVICE_H
#define ONBOARDPROVIDERSOMEIPSERVICE_H
...
/**
 * @brief Received the requested information/data using ClientAPI interface from the SomeIP type client.
 *
 */

class OnBoardProviderSomeIPService : public ClientAPIStubDefault
{
public:
    OnBoardProviderSomeIPService(OnBoardProviderService * onBoardProviderService);
    virtual ~OnBoardProviderSomeIPService();
...
#endif // ONBOARDPROVIDERSOMEIPSERVICE_H
