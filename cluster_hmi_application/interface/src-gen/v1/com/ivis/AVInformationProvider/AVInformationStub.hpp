...
class AVInformationStubAdapter
 ...
 public:
    ...
    ///Notifies all remote listeners about a change of value of the attribute systemTime.
    virtual void fireSystemTimeAttributeChanged(const uint32_t& systemTime) = 0;
...
public:
    ...
    /// Verification callback for remote set requests on the attribute systemTime
    virtual bool onRemoteSetSystemTimeAttribute(const std::shared_ptr<CommonAPI::ClientId> _client, uint32_t _value) = 0;
    /// Action callback for remote set requests on the attribute systemTime
    virtual void onRemoteSystemTimeAttributeChanged() = 0;
};
...
public:
    ...
    /// Provides getter access to the attribute systemTime
    virtual const uint32_t &getSystemTimeAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;
