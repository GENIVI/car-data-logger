...
public:
    ...
    virtual void fireRepeatModeAttributeChanged(::v1::com::ivis::MediaManager::MediaManagerTypes::RepeatMode _value) {
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void firePlayModeAttributeChanged(::v1::com::ivis::MediaManager::MediaManagerTypes::PlayMode _value) {
    auto stubAdapter = CommonAPI::Stub<PlaybackControlStubAdapter, PlaybackControlStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->firePlayModeAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireCurrentTrackInfoAttributeChanged(::v1::com::ivis::MediaManager::MediaManagerTypes::TrackInfo _value) {
    auto stubAdapter = CommonAPI::Stub<PlaybackControlStubAdapter, PlaybackControlStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireCurrentTrackInfoAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireCurrentTrackNumberAttributeChanged(uint32_t _value) {
    auto stubAdapter = CommonAPI::Stub<PlaybackControlStubAdapter, PlaybackControlStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireCurrentTrackNumberAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireTotalTrackNumberAttributeChanged(uint32_t _value) {
    auto stubAdapter = CommonAPI::Stub<PlaybackControlStubAdapter, PlaybackControlStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireTotalTrackNumberAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireVideoVisibleAttributeChanged(bool _value) {
    auto stubAdapter = CommonAPI::Stub<PlaybackControlStubAdapter, PlaybackControlStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireVideoVisibleAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void firePlayStateInfoAttributeChanged(::v1::com::ivis::MediaManager::MediaManagerTypes::PlayStateInfo _value) {
    auto stubAdapter = CommonAPI::Stub<PlaybackControlStubAdapter, PlaybackControlStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->firePlayStateInfoAttributeChanged(_value);
    }
