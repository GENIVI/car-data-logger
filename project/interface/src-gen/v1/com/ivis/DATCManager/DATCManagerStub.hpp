...
public:
    ...
    virtual void fireTemperatureModeAttributeChanged(::v1::com::ivis::DATCManager::DATCManagerTypes::ETemperatureMode _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireTemperatureModeAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireDualModeAttributeChanged(bool _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireDualModeAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireAutoModeAttributeChanged(bool _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireAutoModeAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireAirConditionerRunAttributeChanged(bool _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireAirConditionerRunAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireHeaterRunAttributeChanged(bool _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireHeaterRunAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireInteriorTemperautreAttributeChanged(double _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireInteriorTemperautreAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireExteriorTemperatureAttributeChanged(double _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireExteriorTemperatureAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireTargetTemperaturesAttributeChanged(::v1::com::ivis::DATCManager::DATCManagerTypes::TargetTemperatures _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireTargetTemperaturesAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireFanDirectionsAttributeChanged(::v1::com::ivis::DATCManager::DATCManagerTypes::FanDirections _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireFanDirectionsAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireFanSpeedsAttributeChanged(::v1::com::ivis::DATCManager::DATCManagerTypes::FanSpeeds _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireFanSpeedsAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireDefrostsAttributeChanged(::v1::com::ivis::DATCManager::DATCManagerTypes::Defrosts _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireDefrostsAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireAirRecirculationAttributeChanged(bool _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireAirRecirculationAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireSteeringWheelHeaterAttributeChanged(bool _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireSteeringWheelHeaterAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireSeatHeatersAttributeChanged(::v1::com::ivis::DATCManager::DATCManagerTypes::SeatHeaters _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireSeatHeatersAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireSeatCoolersAttributeChanged(::v1::com::ivis::DATCManager::DATCManagerTypes::SeatCoolers _value) {
    auto stubAdapter = CommonAPI::Stub<DATCManagerStubAdapter, DATCManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireSeatCoolersAttributeChanged(_value);
    }
