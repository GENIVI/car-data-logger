...
void initializeClientAPIRemoteSomeIPProxy() {
...
INITIALIZER(registerClientAPIRemoteSomeIPProxy) {
    CommonAPI::SomeIP::Factory::get()->registerInterface(initializeClientAPIRemoteSomeIPProxy);
}
...
,          notifyData_(*this, 0xc738, CommonAPI::SomeIP::event_id_t(0xc79c), false, false, std::make_tuple(static_cast< CommonAPI::SomeIP::StringDeployment* >(nullptr), static_cast< CommonAPI::SomeIP::StringDeployment* >(nullptr), static_cast< CommonAPI::SomeIP::StringDeployment* >(nullptr), static_cast< ::v1::com::ivis::CDL::ClientAPIRemoteTypes_::CDLDataDeployment_t* >(nullptr)))
    {
    }
