...
private:
    ...
    CommonAPI::DBus::DBusEvent<NotifyDataEvent, CommonAPI::Deployable< std::string, CommonAPI::DBus::StringDeployment >, CommonAPI::Deployable< std::string, CommonAPI::DBus::StringDeployment >, CommonAPI::Deployable< std::string, CommonAPI::DBus::StringDeployment >, CommonAPI::Deployable< ::v1::com::ivis::CDL::ClientAPILocalTypes::CDLData, ::v1::com::ivis::CDL::ClientAPILocalTypes_::CDLDataDeployment_t >> notifyData_;
