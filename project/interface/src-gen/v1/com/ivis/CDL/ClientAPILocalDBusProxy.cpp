...
void initializeClientAPILocalDBusProxy() {
...
INITIALIZER(registerClientAPILocalDBusProxy) {
    CommonAPI::DBus::Factory::get()->registerInterface(initializeClientAPILocalDBusProxy);
}
...
,        notifyData_(*this, "notifyData", "sss(yv)", std::make_tuple(static_cast< CommonAPI::DBus::StringDeployment* >(nullptr), static_cast< CommonAPI::DBus::StringDeployment* >(nullptr), static_cast< CommonAPI::DBus::StringDeployment* >(nullptr), static_cast< ::v1::com::ivis::CDL::ClientAPILocalTypes_::CDLDataDeployment_t* >(nullptr)))
{
}
...
ClientAPILocalDBusProxy::NotifyDataEvent& ClientAPILocalDBusProxy::getNotifyDataEvent() {
    ...
    void ClientAPILocalDBusProxy::storeData(const std::string &_domain, const std::string &_subDomain, const std::string &_id, const ClientAPILocalTypes::CDLData &_data, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info) {
        ...
        CommonAPI::Deployable< ClientAPILocalTypes::CDLData, ::v1::com::ivis::CDL::ClientAPILocalTypes_::CDLDataDeployment_t> deploy_data(_data, static_cast< ::v1::com::ivis::CDL::ClientAPILocalTypes_::CDLDataDeployment_t* >(nullptr));
        CommonAPI::DBus::DBusProxyHelper<
            CommonAPI::DBus::DBusSerializableArguments<
            CommonAPI::Deployable< std::string, CommonAPI::DBus::StringDeployment >,
            CommonAPI::Deployable< std::string, CommonAPI::DBus::StringDeployment >,
            CommonAPI::Deployable< std::string, CommonAPI::DBus::StringDeployment >,
            CommonAPI::Deployable< ClientAPILocalTypes::CDLData, ::v1::com::ivis::CDL::ClientAPILocalTypes_::CDLDataDeployment_t >
            >,
            CommonAPI::DBus::DBusSerializableArguments<
            >
            >::callMethodWithReply(
