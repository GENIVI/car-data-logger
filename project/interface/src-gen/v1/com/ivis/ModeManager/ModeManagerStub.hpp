...
public:
    ...
    virtual void fireActiveApplicationAttributeChanged(::v1::com::ivis::ModeManager::ModeManagerTypes::ApplicationInfo _value) {
    auto stubAdapter = CommonAPI::Stub<ModeManagerStubAdapter, ModeManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireActiveApplicationAttributeChanged(_value);
    }
