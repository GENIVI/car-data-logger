...
public:
    ...
    virtual void fireVehicleSpeedAttributeChanged(::v1::com::ivis::VehicleDataManager::VehicleDataManagerTypes::VehicleSpeed _value) {
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireVinAttributeChanged(std::string _value) {
    auto stubAdapter = CommonAPI::Stub<VehicleDataManagerStubAdapter, VehicleDataManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireVinAttributeChanged(_value);
    }
    /**
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireTransmissionGearStatusAttributeChanged(::v1::com::ivis::VehicleDataManager::VehicleDataManagerTypes::TransmissionGearStatus _value) {
    auto stubAdapter = CommonAPI::Stub<VehicleDataManagerStubAdapter, VehicleDataManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireTransmissionGearStatusAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireDrivingRestrictionAttributeChanged(bool _value) {
    auto stubAdapter = CommonAPI::Stub<VehicleDataManagerStubAdapter, VehicleDataManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireDrivingRestrictionAttributeChanged(_value);
    }
    ...
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireLowFuelWarningAttributeChanged(bool _value) {
    auto stubAdapter = CommonAPI::Stub<VehicleDataManagerStubAdapter, VehicleDataManagerStubRemoteEvent>::stubAdapter_.lock();
    if (stubAdapter)
        stubAdapter->fireLowFuelWarningAttributeChanged(_value);
    }
